...
public class Dice {
  ...
  @edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "EI_EXPOSE_REP2", justification = 
   ...
   * In java there is an invariant assumption that objects that 
   * return true on equals also return the same hashcode.
